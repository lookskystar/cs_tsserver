				...
				<td valign="top">
					...
					<select id="w1" name="_w1">
						...
						<c:forEach items="${tsUsers}" var="user">
							<option value="${user.xm }">${user.xm }</option>
						</c:forEach>
					</select>
				</td>
				<td valign="top">
