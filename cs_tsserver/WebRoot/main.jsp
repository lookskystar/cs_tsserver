	...
	<div id="bs_bannerright">
		...
		<div class="bs_nav">
			<div class="bs_navleft">
				<li>
					欢迎<font color="red">${sessionScope.session_user.xm }</font>用户，今天是
				<script>
			...
			<div class="bs_navright">
				<span class="icon_edit hand" onclick='top.Dialog.open({URL:"userManageAction!updatePwInput.do?id=${sessionScope.session_user.userId}",Title:"修改密码 ",Width:400,Height:200});'>修改密码</span>
...
<div id="fbox">
	...
	<div id="bs_footleft">
	<div id="bs_footright">
		广铁铁路(集团)公司 COPYRIGHT 2013 @ 骁睿科技 
	</div>
	</div>
	</div>
</div>
